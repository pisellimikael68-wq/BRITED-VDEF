...
titre: Échanger une crypto contre une autre sans soulte n'est pas imposable
...
resume: >-
  ...
  déclenche l'imposition. Les échanges entre actifs numériques sans soulte sont neutres.
...
sources:
  ...
  - type: bofip
    ...
    consulte_le: 2026-07-27
  - type: administration
    ref: impots.gouv.fr, Comment déclarer les plus ou moins-values sur cessions d'actifs numériques ?
...
Pour un particulier agissant dans le cadre de la gestion de son patrimoine
privé, la plus-value imposable est soumise en 2026 au PFU de **31,4 %** :
12,8 % d'impôt sur le revenu et 18,6 % de prélèvements sociaux. Une option
pour le barème progressif existe. L'échange sans soulte entre actifs numériques
bénéficie d'un sursis d'imposition : il ne donne pas lieu à déclaration au
moment de cet échange.

## Ce qui se joue vraiment

Un portefeuille qui reste dans des échanges entre actifs numériques sans
soulte ne génère pas d'imposition à ce stade. Une conversion en monnaie ayant
cours légal ou l'achat d'un bien ou service constitue en revanche une cession
imposable. La plus-value se calcule alors sur la valeur globale du portefeuille
au moment de la cession, non opération par opération.
