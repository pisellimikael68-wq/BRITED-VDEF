...
resume: >-
  Partir sans la durée d'assurance requise applique une décote définitive sur
  la pension. Continuer au-delà du taux plein produit à l'inverse une surcote.
  Dans les deux cas, l'effet vaut pour toute la durée de la retraite.
sources:
  - type: texte_legal
...
erreurs_frequentes:
  ...
  - Croire qu'atteindre l'âge légal suffit. Il faut aussi la durée d'assurance requise pour le taux plein.
...
La pension du régime général se calcule à partir d'un taux appliqué au salaire
annuel moyen. Le taux maximal, dit **taux plein**, suppose une durée
d'assurance déterminée par la génération.

Partir avant d'avoir atteint cette durée applique une **décote** : le taux est
minoré par trimestre manquant. Continuer au-delà produit une **surcote** qui
majore la pension.

## Ce qui se joue vraiment

La décote n'est pas une pénalité temporaire. Elle s'applique à la pension pour
toute sa durée. Un départ quatre trimestres trop tôt réduit le revenu de chaque
mois pendant vingt ou vingt-cinq ans.
